...
export default function AuthLayout({ children, side = "right" }) {
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* MAIN CONTAINER — centered, max-width contained */}
      <main className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 py-24">
        <div className="w-full max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <motion.aside
              ...
              initial="hidden"
              animate="visible"
              className={`hidden lg:flex flex-col justify-center px-2 ${
            ...
            >
              <div className="space-y-7">
                ...
                <h1 className="font-display text-5xl xl:text-6xl leading-[1.05]">
                  From research to{" "}
                  <span className="gradient-text">published</span> in minutes.
                </h1>
                ...
                <ul className="space-y-3 text-sm">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <span className="h-7 w-7 rounded-md gradient-bg flex items-center justify-center shrink-0 shadow-[0_4px_14px_rgba(139,92,246,0.30)]">
                ...
                <GlassCard className="p-5 max-w-md">
                  <Quote className="h-5 w-5 text-brand-violet/60 mb-2" />
                  <p className="text-sm leading-relaxed">
                    “We went from 8 hours per article to 3 articles in a
                    morning. The SEO scores beat our manual workflow
                    consistently.”
                  </p>
            ...
            >
              <GlassCard
                glow="violet"
                className="w-full max-w-[460px] mx-auto p-7 md:p-9 relative"
              >
                {/* corner glow accent */}
                <span
                  aria-hidden="true"
                  className="pointer-events-none absolute -top-px left-1/4 right-1/4 h-px bg-linear-to-r from-transparent via-white/40 to-transparent"
                />
                {children}
              </GlassCard>
            </motion.section>
