...
const TableFooter = React.forwardRef(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-white/10 bg-muted/40 font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-left align-middle text-[10px] uppercase tracking-[0.2em] font-semibold text-muted-foreground",
      className
    )}
    {...props}
  />
