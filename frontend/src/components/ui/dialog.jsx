...
const DialogContent = React.forwardRef(
  ({ className, children, ...props }, ref) => (
    <DialogPortal>
      <DialogOverlay />
      {/* Scroll wrapper — ensures dialog stays centered even on tall content */}
      <div className="fixed inset-0 z-50 grid place-items-center overflow-y-auto p-4 pointer-events-none">
        <DialogPrimitive.Content
          ...
          className={cn(
            ...
            "gap-4 p-6 sm:rounded-2xl",
            "glass-strong gradient-border",
            "shadow-[0_24px_60px_-12px_rgba(0,0,0,0.45),0_8px_24px_rgba(139,92,246,0.18)]",
            "data-[state=open]:animate-in data-[state=closed]:animate-out",
            "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        ...
        >
          ...
          <DialogPrimitive.Close
            className={cn(
              "absolute right-4 top-4 rounded-full h-7 w-7",
