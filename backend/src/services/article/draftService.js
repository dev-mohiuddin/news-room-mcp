...
const buildPrompt = ({ topic, targetKeyword, tone, targetWordCount, outline, brief, retryHint }) => {
  ...
  return [
    ...
    "- Every factual claim must be supported by an inline citation whose `url` matches a source URL above (use the canonical URL exactly).",
    ...
    "- Citation density: at least 1 citation per ~300 words within `factual` paragraphs.",
